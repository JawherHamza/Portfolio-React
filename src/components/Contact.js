...
let sendMail = () => {
    ...
    if (name != "" && phone != "" && message != "")
        window.open('mailto:jawher_hamza@yahoo.fr?subject=Contact From My Website' + '&body= Hi i\'m ' + name + ' ' + message + ' My Phone Number : ' + phone + '');
}
                ...
                <Grid container >
                    <Grid item md={8} style={{ padding: '10px' }}>
                        ...
                        <form>
                            ...
                            <Button variant="outlined" style={{ float: 'right', margin: "10px" }} onClick={() => { sendMail() }}>
